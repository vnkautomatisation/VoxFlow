...
--
--  NE PAS recréer :
--    dialer_campaigns, dialer_contacts (008)
--    voicemails (011)
--    quality_score, notes, ended_at, twilio_sid sur calls (012)
--    agents, extension, skills (002+006)
--    contacts (005)
-- ============================================================

-- ── 1. Colonnes profil sur users (manquantes) ────────────────
...
-- ── 2. Colonnes post-appel sur calls (manquantes) ────────────
...
-- ── 3. Colonnes manquantes sur dialer_campaigns (008) ────────
-- (008 a: name, status, type, from_number, max_attempts, etc.)
-- On ajoute seulement ce qui manque pour le portail client
...
SELECT '=== Migration 015 Agent + Dialer OK ===' AS message;
